...
var script$1 = {
  ...
  setup: function setup(__props) {
    ...
    var googleLoginService = new GoogleService({
    ...
    return function (_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("button", {
        onClick: _cache[0] || (_cache[0] = function ($event) {
          return vue.unref(kakaoService).login();
        })
      }, [vue.createElementVNode("img", {
...
};/* eslint-disable import/prefer-default-export */var components$1=/*#__PURE__*/Object.freeze({__proto__:null,GoogleLogin: script$1,KakaoLogin: script});var install = function installVueSocialLogin(app) {
